# Author: Ian Docherty
# Description: This program defines a traditional, feed-forward neural network
#              to be used to train the 1-dimensional raw dataset. The purpose
#              of this program is to discover whether a traditional network is a
#              viable option for classifying the audio files, or if more advanced
...
def main():
    ...
    # Build traditional neural network
    model = Sequential()
